...
//  val ll = scala.collection.mutable.ListBuffer.empty[List[Int]]
  ...
  /*
  * Determine the class
  * this is done by calculating the frequency
  * if frquency 1 is higher belongs to class1
  * else belongs to class2*/
  ...
  * sort and find the find the k smallest distances
  * */
